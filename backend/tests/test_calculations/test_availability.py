...
def calculate_availability_simple(
...
def calculate_oee_availability_component(
    scheduled_hours: float,
    downtime_hours: float
) -> float:
    """
...
class TestAvailabilityBasicCalculation:
    ...
    def test_full_availability(self, expected_availability=None):
        ...
        result = calculate_availability_simple(
            scheduled_hours=8.0,
            downtime_hours=0.0
        )
...
class TestOEEAvailabilityComponent:
    ...
    def test_oee_availability_decimal(self):
        ...
        result = calculate_oee_availability_component(
            scheduled_hours=8.0,
            downtime_hours=0.5
        )
    ...
    def test_oee_calculation_integration(self):
        ...
        availability = calculate_oee_availability_component(
            scheduled_hours=8.0,
            downtime_hours=0.5
        )  # 0.9375
...
class TestAvailabilityBusinessScenarios:
    ...
    def test_24_7_operation_availability(self):
        ...
        result = calculate_availability_simple(
            ...
            downtime_hours=8.0  # 8 hours total downtime
        )
    ...
    def test_categorize_availability_level(self):
        ...
        for availability, expected_category in test_cases:
            ...
            assert result == expected_category, \
                f"Expected {expected_category} for {availability}%"
