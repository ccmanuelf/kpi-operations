...
class TestAlertGenerationResult:
    ...
    def test_dataclass_optional_fields(self):
        ...
        result = AlertGenerationResult(should_alert=False, severity="info", title="Info", message="Message")
...
class TestGenerateEfficiencyAlert:
    ...
    def test_no_trend_alert_not_enough_data(self):
        ...
        result = generate_efficiency_alert(
            current_efficiency=Decimal("88"), target=Decimal("85"), historical_values=historical
        )
    ...
    def test_with_client_name(self):
        ...
        result = generate_efficiency_alert(
            current_efficiency=Decimal("65"), target=Decimal("85"), client_name="Test Client"
        )
...
class TestGenerateQualityAlert:
    ...
    def test_fpy_no_alert_above_target(self):
        ...
        result = generate_quality_alert(kpi_type="fpy", current_value=Decimal("98"), target=Decimal("95"))
        assert result is None
    ...
    def test_fpy_urgent_alert(self):
        ...
        result = generate_quality_alert(kpi_type="fpy", current_value=Decimal("40"), target=Decimal("95"))
    ...
    def test_dpmo_no_alert_below_target(self):
        ...
        result = generate_quality_alert(kpi_type="dpmo", current_value=Decimal("500"), target=Decimal("1000"))
        assert result is None
    ...
    def test_ppm_urgent_alert(self):
        ...
        result = generate_quality_alert(kpi_type="ppm", current_value=Decimal("6000"), target=Decimal("1000"))
    ...
    def test_declining_trend_info_alert(self):
        ...
        result = generate_quality_alert(
            kpi_type="fpy", current_value=Decimal("94"), target=Decimal("90"), historical_values=historical
        )
    ...
    def test_with_product_line(self):
        ...
        result = generate_quality_alert(
            kpi_type="fpy", current_value=Decimal("75"), target=Decimal("95"), product_line="Assembly Line A"
        )
    ...
    def test_default_thresholds(self):
        ...
        result = generate_quality_alert(kpi_type="fpy", current_value=Decimal("80"), target=Decimal("90"))
...
class TestGenerateCapacityAlert:
    ...
    def test_severe_underutilization_alert(self):
        ...
        result = generate_capacity_alert(load_percent=Decimal("60"))
    ...
    def test_below_optimal_info_alert(self):
        ...
        result = generate_capacity_alert(load_percent=Decimal("82"))
    ...
    def test_near_maximum_warning(self):
        ...
        result = generate_capacity_alert(load_percent=Decimal("100"))
    ...
    def test_overloaded_critical_alert(self):
        ...
        result = generate_capacity_alert(load_percent=Decimal("115"))
    ...
    def test_optimal_with_bottleneck(self):
        ...
        result = generate_capacity_alert(load_percent=Decimal("90"), bottleneck_station="Assembly Station 3")
    ...
    def test_with_idle_days_prediction(self):
        ...
        result = generate_capacity_alert(load_percent=Decimal("60"), predicted_idle_days=3)
    ...
    def test_with_overtime_hours(self):
        ...
        result = generate_capacity_alert(load_percent=Decimal("110"), overtime_hours_needed=Decimal("24"))
    ...
    def test_custom_optimal_range(self):
        ...
        result = generate_capacity_alert(
            load_percent=Decimal("80"), optimal_min=Decimal("90"), optimal_max=Decimal("98")
        )
...
class TestGeneratePredictionBasedAlert:
    ...
    def test_insufficient_historical_data(self):
        ...
        result = generate_prediction_based_alert(
            kpi_key="efficiency", historical_values=[Decimal("90"), Decimal("88")], target=Decimal("85")
        )
        assert result is None
    ...
    def test_forecast_exception_returns_none(self, mock_forecast):
        ...
        result = generate_prediction_based_alert(
            kpi_key="efficiency", historical_values=historical, target=Decimal("85")
        )
...
class TestGenerateAttendanceAlert:
    ...
    def test_no_alert_below_target(self):
        ...
        result = generate_attendance_alert(absenteeism_rate=Decimal("3"))
        assert result is None
    ...
    def test_urgent_alert(self):
        ...
        result = generate_attendance_alert(
            absenteeism_rate=Decimal("30"), target_rate=Decimal("5")  # Far above 5% target * 5 = 25%
        )
    ...
    def test_coverage_gap_in_message(self):
        ...
        result = generate_attendance_alert(
            absenteeism_rate=Decimal("14"), floating_pool_available=3, coverage_needed=10
        )
    ...
    def test_floating_pool_can_cover(self):
        ...
        result = generate_attendance_alert(
            absenteeism_rate=Decimal("14"), floating_pool_available=15, coverage_needed=10
        )
    ...
    def test_metadata_includes_coverage_info(self):
        ...
        result = generate_attendance_alert(absenteeism_rate=Decimal("10"), floating_pool_available=5, coverage_needed=8)
...
class TestGenerateHoldAlert:
    ...
    def test_info_alert_few_holds(self):
        ...
        result = generate_hold_alert(pending_holds_count=2)
    ...
    def test_warning_alert_many_holds(self):
        ...
        result = generate_hold_alert(pending_holds_count=8)
    ...
    def test_warning_alert_aging_hold(self):
        ...
        result = generate_hold_alert(pending_holds_count=2, oldest_hold_hours=12)
    ...
    def test_critical_alert_over_24_hours(self):
        ...
        result = generate_hold_alert(pending_holds_count=1, oldest_hold_hours=30)
    ...
    def test_message_includes_oldest_hours(self):
        ...
        result = generate_hold_alert(pending_holds_count=3, oldest_hold_hours=16)
    ...
    def test_message_includes_units_on_hold(self):
        ...
        result = generate_hold_alert(pending_holds_count=2, total_units_on_hold=500)
    ...
    def test_metadata_includes_hold_info(self):
        ...
        result = generate_hold_alert(pending_holds_count=3, oldest_hold_hours=10, total_units_on_hold=250)
...
class TestAlertIntegration:
    ...
    def test_multiple_alerts_different_severities(self):
        ...
        # Efficiency alert
        eff_alert = generate_efficiency_alert(current_efficiency=Decimal("65"), target=Decimal("85"))

        # Quality alert
        qual_alert = generate_quality_alert(kpi_type="fpy", current_value=Decimal("80"), target=Decimal("95"))

        # Attendance alert
        att_alert = generate_attendance_alert(absenteeism_rate=Decimal("10"))
