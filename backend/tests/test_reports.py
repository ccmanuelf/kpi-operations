...
# Mock authentication (replace with actual test user setup)
@pytest.fixture
def auth_headers():
...
class TestReportEndpoints:
    ...
    def test_get_available_reports(self, auth_headers):
        ...
        response = client.get("/api/reports/available", headers=auth_headers)
    ...
    def test_generate_production_pdf(self, auth_headers):
    ...
    def test_generate_production_excel(self, auth_headers):
    ...
    def test_generate_quality_pdf(self, auth_headers):
    ...
    def test_generate_quality_excel(self, auth_headers):
    ...
    def test_generate_attendance_excel(self, auth_headers):
    ...
    def test_generate_comprehensive_pdf(self, auth_headers):
    ...
    def test_generate_comprehensive_excel(self, auth_headers):
    ...
    def test_start_date_after_end_date(self, auth_headers):
    ...
    def test_client_filtering(self, auth_headers):
