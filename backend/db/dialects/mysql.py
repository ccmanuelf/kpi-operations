...
class MySQLDialect(DialectAdapter):
    ...
    def get_upsert_sql(
        ...
        # (SQLAlchemy table/column metadata), never from user-controllable
        # input. SQL doesn't allow parameterizing identifiers; whitelist
        # enforcement is the standard mitigation.
