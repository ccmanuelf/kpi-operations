...
def get_quality_statistics(
    ...
    return {
        ...
        "shift_id": shift_id,
        "total_units_inspected": int(result.total_inspected or 0),
        "total_defects_found": int(result.total_defects or 0),
        "total_scrap_units": int(result.total_scrap or 0),
        "total_rework_units": int(result.total_rework or 0),
