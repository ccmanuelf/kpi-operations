...
def create_inspection(db: Session, inspection_data, current_user: User):
    """Create a new quality inspection."""
    return create_quality_inspection(db, inspection_data, current_user)


def get_inspection(db: Session, inspection_id: str, current_user: User):
...
def update_inspection(db: Session, inspection_id: str, inspection_data, current_user: User):
