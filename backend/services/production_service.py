...
class ProductionService:
    ...
    def create_entry(self, data: ProductionEntryCreate, user: User) -> ProductionEntry:
        """
    ...
    def get_daily_summary(
        self, user: User, start_date: date, end_date: Optional[date] = None, client_id: Optional[str] = None
    ) -> List[dict]:
        """
    ...
    def batch_import(self, entries: List[ProductionEntryCreate], user: User) -> List[ProductionEntry]:
        """
