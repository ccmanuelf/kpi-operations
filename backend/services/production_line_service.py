...
def create_line(db: Session, data: dict):
    """Create a new production line."""
    return create_production_line(db, data)


def list_lines(db: Session, client_id: str, include_inactive: bool = False):
...
def get_line_tree(db: Session, client_id: str):
