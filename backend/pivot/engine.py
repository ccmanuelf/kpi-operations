...
from backend.pivot.registry import DATASETS, Count, Dataset, Ratio, Share, Sum
...
def _derived(ds: Dataset, comps: dict[str, float], window_totals: dict[str, float]) -> dict[str, Any]:
    out: dict[str, Any] = {}
