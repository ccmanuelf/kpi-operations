...
**Group F complete (1/1 surface).** BOM master-detail rebuilt as two stacked AGGridBase grids — Community-Edition equivalent of master-detail. Picks up the previously-orphaned component-level endpoints from Phase 0 § 6.7. **16/20 surfaces complete (80%).**
