...
Next per the Phase 1 plan: **Group C — Capacity worksheet AG Grid rebuilds** (5 surfaces, ~1–2 weeks). The 6 capacity v-data-table worksheets at `views/CapacityPlanning/components/grids/` need to be rebuilt on `AGGridBase` using the patterns established in Groups A + B.
