...
**Group D in progress (4/5 surfaces).** Production Lines + Stock + Standards + Calendar rebuilt on AGGridBase.
...
**8 surfaces remaining out of 20 total. Group A + B + C + D-4 = 12/20 complete (60%).**
