<template>
  <v-container fluid>
    ...
    <!-- How-To Guide Dialog -->
    <SimulationGuideDialog
      v-model="showGuide"
      :guide="guide"
      :guide-tab="guideTab"
      @load-example="loadExampleScenario"
...
<script setup>
import SimulationGuideDialog from '@/components/simulation/SimulationGuideDialog.vue'
import { useSimulationData } from '@/composables/useSimulationData'
import { useSimulationScenarios } from '@/composables/useSimulationScenarios'
...
const {
  ...
  removeScenario,
  compareScenarios
} = useSimulationScenarios(productionLineConfig, simulationParams, loading)
</script>
