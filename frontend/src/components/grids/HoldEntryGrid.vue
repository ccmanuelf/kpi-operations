<template>
  <v-card>
    <v-card-title class="d-flex justify-space-between align-center bg-primary" data-testid="holds-grid-header">
      <div class="d-flex align-center">
        <v-icon class="mr-2">mdi-pause-circle</v-icon>
        <span class="text-h5">{{ $t('grids.holds.title') }}</span>
      </div>
      <div>
        <v-btn color="white" variant="outlined" @click="addNewHold" class="mr-2" data-testid="holds-add-row-btn">
