...
async function navigateVia(page: Page, href: string) {
  ...
  // resolves when long-lived connections (e.g. Vite HMR websocket,
  // pending API fetches) are open, which is the CI cold-start failure
  // mode that originally drove the Phase B.7 skips.
